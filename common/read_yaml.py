...
class ReadYaml():
    def __init__(self,filename):
        self.filepath = os.path.abspath(os.path.dirname(os.path.dirname(__file__)) + r"/configs/test")+"/"+filename#拼接定位到data文件夹
...
if __name__ == '__main__':
    ...
    # D:\\RJ\\daima\\jieKou\\yaml - pytest\\case\\qiantai_duo_jiekou\\configs / test / data.yml
    # D:\RJ\daima\jieKou\yaml - pytest\configs\test\data.yml
